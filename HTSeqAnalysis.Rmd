...
countsDir <- file.path("../Kitashiba2014_0")
...
```{r GlobalKitashiba1, echo=FALSE, eval=FALSE}
...
countsDir <- file.path("../Mitsui2015_0")
...
countsDir <- file.path("../Jeong2016_0")
...
countsDir <- file.path("../Moghe2014_0")
...
outputfilenameCounts <- ("../DEseqOutput/Moghe2014_counts_1.csv")
...
raphpsedo.DES <- DESeqDataSetFromMatrix(countData = exprs( raph.est ), colData = pData( raph.est ), design = ~ LocationLine + FlowCell )
